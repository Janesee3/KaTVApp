...
class AppInheritedWidgetState extends State<AppInheritedWidget> {
  ...
  void _addSong(Song reference, BuildContext context) {
    setState(() {
  ...
  void _removeFirstSong() {
    setState(() {
      if (_songs.length > 0) _songs.removeAt(0);
    });
  }

  void _pushSongToTop(Song song, int songIndex) {
    setState(() {
  ...
  void _removeSong(int songIndex) {
    setState(() {
      _songs.removeAt(songIndex);
    });
  }
                          ...
                          child: Row(
                            children: <Widget>[
                              IconButton(
                                ...
                                onPressed: () => state._pushSongToTop(
                                    state.songs[position], position),
                              ),
                              IconButton(
                                icon: Icon(Icons.delete),
                                onPressed: () => state._removeSong(position),
                              )
                            ],
                          ),
                        ),
